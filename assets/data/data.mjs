...
export const ITEMS = {
  ...
  setSquare: {name: 'Set Square', type: ITEM_TYPE.TRINKET, stype: 'trinket', star: 3, image: 'furniture_32_32-3-8', help: 'Surveyor\'s Tools', tooltip: 'When in Inventory, press [R] display perception range', buff: [{buff: 'showInteractionRange', value: true}]},
