...
export const ITEMS = {
  ...
  // hammers
  hammerOak: {name: 'Wood Hammer', type: ITEM_TYPE.TOOL, stype: 'hammer', star: 1, image: 'tool_32_32-0-5', placed: 'handed_48_48-1-1', range: 0, shaking: {speed: 0}, help: 'Hammers', tooltip: 'Tools used to remove wall, furniture, workstation, converting them to item form'},
  ...
  hammerSilver: {name: 'Silver Hammer', type: ITEM_TYPE.TOOL, stype: 'hammer', star: 4, image: 'tool_32_32-2-1', placed: 'handed_48_48-1-1', range: 0, shaking: {speed: 50}, help: 'Hammers', tooltip: 'Tools used to remove wall, furniture, workstation, converting them to item form'},
  hammerGold: {name: 'Gold Hammer', type: ITEM_TYPE.TOOL, stype: 'hammer', star: 4, image: 'tool_32_32-3-1', placed: 'handed_48_48-1-1', range: 1, shaking: {speed: 75}, help: 'Hammers', tooltip: 'Tools used to remove wall, furniture, workstation, converting them to item form'},
  hammerCobalt: {name: 'Cobalt Hammer', type: ITEM_TYPE.TOOL, stype: 'hammer', star: 5, image: 'tool_32_32-4-1', placed: 'handed_48_48-1-1', range: 2, shaking: {speed: 100}, help: 'Hammers', tooltip: 'Tools used to remove wall, furniture, workstation, converting them to item form'},
  hammerPlatinum: {name: 'Cobalt Hammer', type: ITEM_TYPE.TOOL, stype: 'hammer', star: 5, image: 'tool_32_32-5-1', placed: 'handed_48_48-1-1', range: 3, shaking: {speed: 150}, help: 'Hammers', tooltip: 'Tools used to remove wall, furniture, workstation, converting them to item form'},
  ...
  bloodmoon: {name: 'Bloodmoon', type: 0, stype: 'herb', star: 2, image: 'potions_32_32-1-5', placed: 'placed_16_32-4-0', placedLeft: 'placed_16_32-5-0', help: 'Bloodmoon', tooltip: '???', foraging: {speed: 1500, items: [{item: 'bloodmoon', count: '1-3'}, {item: 'bloodmoonSeed', count: 0.65}, {item: 'slug', count: 0.12, buffs: ['lucky:100', 'rainy:300']}]}},
