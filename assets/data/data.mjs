...
export const ITEMS = {
  ...
  bucketWater: {name: 'Water Bucket', type: ITEM_TYPE.FURNITURE | ITEM_TYPE.POURABLE, stype: 'container', star: 1, image: 'container_32_32-1-1', placed: 'container_32_32-1-1', help: 'Buckets', tooltip: 'Amount of water. Can be poured out', pouring: {liquid: NODES.WATER.code, container: 'bucket'}},
  bucketSap: {name: 'Sap Bucket', type: ITEM_TYPE.FURNITURE | ITEM_TYPE.POURABLE, stype: 'container', star: 1, image: 'container_32_32-2-1', placed: 'container_32_32-1-1', help: 'Buckets', tooltip: 'Amount of sap. Can be poured out', pouring: {liquid: NODES.SAP.code, container: 'bucket'}},
  bucketHoney: {name: 'Honey Bucket', type: ITEM_TYPE.FURNITURE | ITEM_TYPE.POURABLE, stype: 'container', star: 1, image: 'container_32_32-3-1', placed: 'container_32_32-1-1', help: 'Buckets', tooltip: 'Amount of honey. Can be poured out', pouring: {liquid: NODES.HONEY.code, container: 'bucket'}},
