...
export const NODES = {
  ...
  GRASSJUNGLE: {code: 31, name: 'Jungle Grass', type: NODE_TYPE.NATURAL | NODE_TYPE.SOLID, star: 2, color: '#56ba27', image: 'grass_16_16+1', mining: {speed: 500, items: [{item: 'blockSilt', count: 1}, {item: 'seedJungle', count: 0.15}], foraging: [{item: 'seedJungle', count: 0.15, lucky: 1.5}, {item: 'slug', count: 0.05, lucky: 2, rainy: 10}]}, help: 'Jungle Grass'},
  ...
  GRASSFERN: {code: 33, name: 'Fern Grass', type: NODE_TYPE.NATURAL | NODE_TYPE.SOLID, star: 4, color: '#56ba27', image: 'grass_16_16+3', speed: 500, mining: {speed: 500, items: [{item: 'blockHumus', count: 4, lucky: 5}, {item: 'fernLeaf', count: 0.2, lucky: 75}], foraging: [{item: 'fernLeaf', count: 0.6, lucky: 1.5}, {item: 'frog', count: 0.2, lucky: 50}, {item: 'fernSpore', count: 0.1, lucky: 50}]}, help: 'Fern Grass'},
  GRASSMOSS: {code: 34, name: 'Moss Grass', type: NODE_TYPE.NATURAL | NODE_TYPE.SOLID, star: 4, color: '#b73ed6ff', image: 'grass_16_16+4', mining: {speed: 500, items: [{item: 'blockSilt', count: 1, lucky: 2.5}], foraging: [{item: 'moss', count: 1, lucky: 1.4}]}, help: 'Moss Grass'},
