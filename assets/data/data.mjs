...
export const ITEMS = {
  ...
  sneakthorn: {name: 'Sneakthorn', type: 0, stype: 'herb', star: 4, image: 'foraged_32_32-1-5', placed: 'placed_32_32-1-3', foraging: {speed: 500, items: [{item: 'sneakthorn', count: 1, rainy: 1.8, windy: 1.8}]}, help: 'Sneakthorn', tooltip: 'Harvest to collect Potions and Food ingredients'},
