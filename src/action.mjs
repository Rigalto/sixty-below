...
class SowingManager {
  ...
  /**
   * Valide et exécute la transformation d'une tuile HUMUS en GRASSFERN via une FernSpore.
   * Contrairement aux ForestGrassSeed/JungleGrassSeed, la transformation est instantanée —
   * aucune germination différée. La création du spot fougère (present=false) est déléguée
   * à FernSystem.onFernSpotCheck, déclenché réactivement par l'événement world/tile-changed.
   ...
   * @param {number} slotIndex
   */
  #trySowFernSpore (tileIndex, tileNode, slotIndex) {
