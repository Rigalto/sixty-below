...
export const TOPSOIL_Y_CAVERNS_MID = 500 // environ (CANVAS_HEIGHT + TOPSOIL_Y_UNDER_CAVERNS) / 2
...
export const PATH_SAVE = 'M2 4a2 2 0 0 1 2-2h13.17a2 2 0 0 1 1.41 0.59l2.83 2.83a2 2 0 0 1 0.59 1.41v13.17a2 2 0 0 1-2 2h-16a2 2 0 0 1-2-2zM4 4v16h16v-12.8l-3.2-3.2zM6 3h2v5h6v-5h2v5a2 2 0 0 1-2 2h-6a2 2 0 0 1-2-2zM8 15a4 4 0 0 1 8 0 4 4 0 0 1-8 0zM10 15a2 2 0 0 0 4 0 2 2 0 0 0-4 0z'
export const PATH_RESTORE = 'M13.6 1a1.6 1.6 0 0 1 1.6 1.6v4.8h3.67a1.6 1.6 0 0 1 1.13 2.73l-6.3 6.3a2.4 2.4 0 0 1-3.39 0l-6.3-6.3a1.6 1.6 0 0 1 1.13-2.73h3.67v-4.8a1.6 1.6 0 0 1 1.6-1.6zM13.2 3h-2.4v6.4h-4.8l6 6 6-6h-4.8zM14 14h8a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-20a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h8v2h-8v5h20v-5h-8zM18 18a1 1 0 0 1 2 0 1 1 0 0 1-2 0z'
...
export const MICROTASK = {
  ...
  GIANT_MUSHROOM_END_SHAKE: {priority: 24, capacity: 4, taskName: 'giantMushroomEndShake'}, // fin de la période où un giant mushroom n'est pas shakable
