...
| `digCobwebCaves` | `(underCaverns: Int16Array): Array<{cx, cy, radiusX, radiusY}>` | Creuse 4–8 cavernes elliptiques dans tous les biomes, cavern_top (80%) ou cavern_bottom (25%). COBWEB différé. Rectangle englobant enregistré dans #exclusions. Constantes dans `data-gen.mjs`. |
